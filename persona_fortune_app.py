...
PERSONA_FORTUNE = {
    "mz_shaman": {
        "총운": [
            "오늘 촉이 미친 듯이 좋아! 아침부터 느낌 쎄한데, 그거 믿고 가도 돼.",
            "뭔가 스치듯 지나가는 촉이 있을 거야, 그거 놓치지 말고 딱 붙잡아.",
            "오늘 기운이 롤러코스터처럼 오르락내리락하는데, 오후 되면 확 풀릴 거야.",
            "촉 쎄게 오는 날이라 직감대로 움직이면 대박 날 수도 있어.",
        ],
        "애정운": [
            "썸 타는 사람 있으면 오늘 촉 진짜 좋으니까 먼저 연락해봐.",
            "괜히 신경 쓰이는 그 사람, 오늘 답 올 것 같은 촉인데?",
            "혼자인 사람은 오늘 우연히 스친 인연이 예사롭지 않을 수도 있어.",
            "커플이면 오늘 사소한 걸로 투닥거릴 수 있는데, 그냥 웃어넘겨.",
        ],
        "재물운": [
            "오늘 지갑 열 일 생기는데, 그만큼 다시 채워질 촉이 보여.",
            "괜히 아까웠던 돈, 오늘 뜻밖에 돌아올 촉이 딱 온다.",
            "충동구매 촉 조심해, 오늘따라 유혹이 세게 온다.",
            "돈 관련해서 좋은 소식 하나 들어올 것 같은 촉이야.",
        ],
        "건강운": [
            "몸보다 마음이 먼저 피곤한 날이니까, 오늘은 좀 쉬어.",
            "괜히 어깨 뭉치는 느낌 있으면 스트레칭 한 번 해줘, 완전 개운해질 촉.",
            "커피보다 물 마시라는 촉이 계속 온다, 오늘만이라도 들어봐.",
            "잠 잘 자면 오늘 컨디션 미쳐, 일찍 자는 거 강추.",
        ],
        "인간관계운": [
            "단체 톡방에서 한마디 던지면 반응 완전 좋을 촉이야.",
            "괜히 어색했던 사람이랑 오늘 자연스럽게 풀릴 촉이 온다.",
            "누가 부탁하면 거절해도 괜찮은 날이니까 눈치 보지 마.",
            "오랜만에 연락 오는 사람 있을 촉인데, 반갑게 받아줘.",
        ],
    },
    "tarot_master": {
        "총운": [
            "카드가 보여준 첫 장면은 안개 속의 등불이었습니다. 오전은 흐릿해도 오후엔 길이 보일 것입니다.",
            "펼쳐진 카드 속, 문이 살짝 열려 있더군요. 오늘은 새로운 기회가 슬며시 다가옵니다.",
            "카드 위에 비친 것은 저울입니다. 균형을 잃지 않는 것이 오늘의 핵심이 될 것입니다.",
            "카드가 조용히 웃고 있습니다. 오늘은 애쓰지 않아도 흐름이 알아서 풀릴 날입니다.",
        ],
        "애정운": [
            "카드 속 두 개의 잔이 나란히 놓여 있습니다. 오늘은 마음을 나눌 좋은 때입니다.",
            "닫혀 있던 카드 하나가 스스로 열리는군요. 먼저 다가가면 반가운 답이 옵니다.",
            "카드가 보여준 것은 흔들리는 촛불입니다. 감정이 오갈 수 있으니 다정함을 잃지 마세요.",
            "혼자 있는 인물이 그려진 카드입니다. 오늘은 조급해하지 않아도 괜찮습니다.",
        ],
        "재물운": [
            "동전이 그려진 카드가 뒤집혀 있습니다. 예상 밖의 지출이나 수입, 둘 다 가능성이 있습니다.",
            "카드 속 금고가 살짝 열려 있습니다. 신중하게 열어보면 좋은 것이 나올 것입니다.",
            "저울이 한쪽으로 기운 카드입니다. 오늘은 충동보다 계획이 필요합니다.",
            "씨앗이 그려진 카드가 나왔습니다. 오늘 심는 것이 훗날 자산이 될 것입니다.",
        ],
        "건강운": [
            "카드 속 인물이 지쳐 누워 있습니다. 몸보다 마음을 먼저 돌보아야 할 때입니다.",
            "물이 흐르는 카드입니다. 오늘은 몸에 수분을 채워주는 것이 도움이 될 것입니다.",
            "구부러진 나뭇가지가 그려진 카드, 긴장된 몸을 풀어줄 필요가 있습니다.",
            "달이 차오르는 카드입니다. 일찍 쉬면 내일의 기운이 채워질 것입니다.",
        ],
        "인간관계운": [
            "두 사람이 마주 보는 카드입니다. 솔직한 말 한마디가 오늘의 열쇠입니다.",
            "카드 속 다리가 두 땅을 잇고 있습니다. 당신이 중재자가 될 수 있는 날입니다.",
            "오래된 편지가 그려진 카드, 그리운 이에게서 소식이 올 수 있습니다.",
            "홀로 앉은 인물의 카드입니다. 오늘은 혼자만의 시간도 나쁘지 않습니다.",
        ],
    },
    "grandma_shaman": {
        "총운": [
            "아침엔 흐릿해도 오후 되믄 다 풀릴 텡께 걱정 붙들어매소.",
            "오늘 누가 도와줄 사람 하나 나타날 겨, 두고봐.",
            "촉 좋은 날이니께 마음 가는 대로 혀도 되아.",
            "작은 실수 하나쯤은 그냥 넘어가소, 큰일 아니여.",
        ],
        "애정운": [
            "먼저 말 한마디 건네면 오해 싹 풀릴 겨.",
            "혼자면 오늘 우연히 좋은 인연 만날 수도 있응께 밖에 나가보소.",
            "부부간에 사소한 걸로 다툴 수 있응께 말 곱게 하소.",
            "그리운 사람한테서 오늘 연락 올 수도 있겄네.",
        ],
        "재물운": [
            "오늘 돈 좀 나갈 수 있는디, 그만큼 또 들어올 텡께 걱정 마소.",
            "충동적으로 뭐 사지 말고 하루만 참아보소.",
            "동네 사람이랑 돈 거래는 이번 주는 삼가는 게 좋겄네.",
            "저축 습관 오늘부터 들여보소, 작은 게 큰 거 된당께.",
        ],
        "건강운": [
            "몸보다 맘이 먼저 지친 날이여, 잠깐 쉬었다 가소.",
            "일찍 자면 낼 컨디션이 확 다를 겨.",
            "어깨 뭉친 데 있으면 슬슬 풀어주소.",
            "물 자주 마시고 커피는 좀 줄이소.",
        ],
        "인간관계운": [
            "말 한마디가 오늘 누구한테 큰 힘이 될 겨.",
            "둘이 다투는 데 끼면 한쪽 편들지 말고 가만있소.",
            "오랜만에 연락 온 사람 있으면 반갑게 받아주소.",
            "혼자 있고 싶으면 억지로 약속 잡지 말고 쉬소.",
        ],
    },
    "baby_fox": {
        "총운": [
            "코가 간질간질해! 오늘 뭔가 좋은 냄새가 나는 것 같아!",
            "귀를 쫑긋 세워봐, 좋은 소식이 들려올 것 같아!",
            "꼬리가 살랑살랑, 오늘은 왠지 기분 좋은 하루가 될 것 같아!",
            "작은 실수해도 괜찮아! 금방 다시 방긋 웃을 수 있어!",
        ],
        "애정운": [
            "킁킁, 누군가한테 연락하고 싶은 냄새가 나는데?! 지금 보내봐!",
            "혼자여도 괜찮아, 오늘 우연히 만난 친구가 특별할 수도 있어!",
            "투닥거려도 금방 화해할 수 있는 냄새가 난다!",
            "그리운 사람한테서 소식 올 것 같아, 귀 쫑긋 세우고 기다려봐!",
        ],
        "재물운": [
            "오늘 용돈이나 선물 생길 것 같은 냄새가 솔솔 나!",
            "사고 싶은 거 있어도 오늘은 참아보자, 내일 더 좋은 게 있을지도!",
            "친구랑 돈 문제는 오늘 살짝 조심하는 게 좋을 것 같아!",
            "저금통에 동전 하나씩 모으는 재미, 오늘부터 시작해볼까?!",
        ],
        "건강운": [
            "몸보다 마음이 좀 지쳤나봐, 낮잠 한숨 자고 나면 괜찮아질 거야!",
            "물 많이 마시면 오늘 컨디션 최고일 거야!",
            "몸이 뻐근하면 콩콩 뛰면서 풀어줘봐!",
            "일찍 자면 내일 훨씬 쌩쌩할 거야, 약속!",
        ],
        "인간관계운": [
            "친구들 모인 데서 한마디 하면 완전 인기 많아질 거야!",
            "어색했던 친구랑 오늘 자연스럽게 풀릴 것 같아!",
            "오랜만에 만나는 친구 있으면 꼬리 흔들며 반겨줘!",
            "혼자 놀고 싶은 날이면 억지로 나가지 않아도 괜찮아!",
        ],
    },
    "fortune_master40": {
        "총운": [
            "오늘은 목(木)의 기운이 강하게 작용하는 날로, 오전보다 오후에 판단력이 살아납니다.",
            "사주에 이르길, 귀인이 나타나는 흐름이 보입니다. 주변을 잘 살피시길 바랍니다.",
            "직감이 예리해지는 날이니, 중요한 결정은 마음이 가는 대로 하셔도 무방합니다.",
            "작은 구설이 있을 수 있으나 크게 번지지 않으니 마음에 담아두지 마십시오.",
        ],
        "애정운": [
            "오늘은 인연의 기운이 살아나는 날입니다. 먼저 다가가는 것이 유리합니다.",
            "혼인이나 만남의 기운이 약하게 흐르니, 새로운 자리에 나가보시길 권합니다.",
            "가까운 사이일수록 말을 아끼는 것이 오늘의 지혜입니다.",
            "그리운 인연에게서 소식이 닿을 수 있는 날입니다.",
        ],
        "재물운": [
            "재물운이 들고 나는 흐름이라, 지출과 수입이 함께 움직일 것입니다.",
            "충동적인 지출보다 계획된 소비가 오늘의 재운에 유리합니다.",
            "금전 거래는 신중을 기하시는 것이 좋겠습니다.",
            "작은 재테크 습관이 훗날 큰 자산이 될 흐름입니다.",
        ],
        "건강운": [
            "몸보다 마음의 기운이 먼저 지치는 날이니, 휴식을 권합니다.",
            "수면의 질이 오늘 컨디션을 좌우하는 요인이 됩니다.",
            "기가 뭉치는 부위가 있을 수 있으니 몸을 풀어주시길 바랍니다.",
            "과로를 삼가고 몸이 보내는 신호에 귀 기울이시길 바랍니다.",
        ],
        "인간관계운": [
            "오늘 건넨 말 한마디가 상대에게 큰 힘이 될 것입니다.",
            "중재자의 역할을 맡게 될 흐름이니, 중립을 지키시길 바랍니다.",
            "오랜 인연과의 대화가 뜻밖의 좋은 기회로 이어질 수 있습니다.",
            "혼자만의 시간이 필요하다면 무리하지 않으셔도 좋습니다.",
        ],
    },
    "joseon_monk": {
        "총운": [
            "아침의 안개는 곧 걷히는 법이오. 오후엔 길이 선명해질 것이오.",
            "오늘은 좋은 인연이 스치듯 지나갈 수 있으니 눈을 밝게 하시오.",
            "직감이 밝아지는 날이니, 마음이 이끄는 대로 하여도 무방하오.",
            "작은 허물은 물처럼 흘려보내도 좋소.",
        ],
        "애정운": [
            "말 한마디가 얼어붙은 마음을 녹이는 법이오. 먼저 다가가 보시오.",
            "홀로인 이는 오늘 뜻밖의 인연을 마주할 수도 있소.",
            "가까운 사이일수록 말을 아끼는 것이 지혜로운 법이오.",
            "그리운 이에게서 소식이 닿을 인연이오.",
        ],
        "재물운": [
            "재물은 물과 같아 흐르고 채워지는 법이니 조급해 마시오.",
            "충동보다 헤아림이 오늘의 재물을 지키는 법이오.",
            "금전의 거래는 신중히 하시오.",
            "작은 절제가 훗날 큰 복이 되는 법이오.",
        ],
        "건강운": [
            "몸보다 마음이 먼저 지치는 날이니 잠시 쉬어가시오.",
            "잠을 청함이 오늘의 기운을 채우는 법이오.",
            "굳은 몸을 풀어주는 것이 오늘의 수행이오.",
            "무리한 걸음은 삼가고 몸이 전하는 소리에 귀 기울이시오.",
        ],
        "인간관계운": [
            "무심한 말 한마디가 누군가에게 큰 위로가 될 수 있소.",
            "다투는 이들 사이에서는 중심을 지키는 것이 도리요.",
            "오랜 인연과의 대화가 뜻밖의 인연으로 이어질 수 있소.",
            "홀로 있고자 하면 억지로 자리를 만들지 않아도 좋소.",
        ],
    },
    "fox_spirit": {
        "총운": [
            "달빛이 구름에 가려졌다가 다시 드러나듯, 오후엔 흐름이 선명해질 것이네.",
            "오늘은 그림자 속에서 좋은 인연이 스칠 것이네, 눈을 밝게 하게.",
            "천 년을 산 여우도 오늘만큼은 그대의 직감을 믿으라 하네.",
            "작은 실수는 달빛 아래 그림자처럼 곧 사라질 것이네.",
        ],
        "애정운": [
            "달빛 아래 나눈 말 한마디가 마음을 녹이는 법이네.",
            "홀로 걷는 이에게 오늘 뜻밖의 인연이 스칠 수 있네.",
            "가까운 사이일수록 말을 아끼는 것이 지혜라네.",
            "그리운 이의 소식이 달빛을 타고 올 것이네.",
        ],
        "재물운": [
            "재물은 달의 차고 이지러짐과 같아, 오늘은 나가고 들어옴이 함께하네.",
            "충동보다 헤아림이 오늘의 재물을 지키는 법이네.",
            "금전의 거래는 신중히 임하게.",
            "작은 절제가 훗날 큰 복으로 돌아올 것이네.",
        ],
        "건강운": [
            "몸보다 마음이 먼저 지치는 날이니 잠시 쉬어가게.",
            "달이 차오르듯 일찍 잠들면 기운이 채워질 것이네.",
            "굳은 몸을 풀어주는 것이 오늘의 처방이네.",
            "몸이 보내는 신호에 귀 기울이게, 무리하지 말게.",
        ],
        "인간관계운": [
            "무심한 말 한마디가 누군가에게 큰 힘이 될 수 있네.",
            "다투는 이들 사이에서는 중심을 지키는 것이 지혜라네.",
            "오랜 인연과의 대화가 뜻밖의 좋은 흐름으로 이어질 수 있네.",
            "홀로 있고자 하면 억지로 자리를 만들지 않아도 좋네.",
        ],
    },
    "cat_sage": {
        "총운": [
            "냥, 오전엔 흐릿해도 오후엔 다 보인다냥. 지켜보고 있으라냥.",
            "오늘 누가 도와줄 것 같다냥, 기대해도 좋다냥.",
            "촉이 좋은 날이다냥, 마음 가는 대로 해도 된다냥.",
            "작은 실수는 신경 쓰지 말라냥, 별거 아니다냥.",
        ],
        "애정운": [
            "먼저 말 걸어보라냥, 반응 나쁘지 않을 거다냥.",
            "혼자여도 괜찮다냥, 오늘 우연한 만남이 있을 수도 있다냥.",
            "다퉈도 금방 풀릴 거다냥, 걱정 말라냥.",
            "그리운 사람한테 연락 올 것 같다냥, 기다려보라냥.",
        ],
        "재물운": [
            "오늘 돈 좀 나갈 수 있다냥, 그만큼 들어올 거다냥.",
            "사고 싶은 거 있어도 하루만 참으라냥.",
            "돈 거래는 이번엔 조심하라냥.",
            "저축 습관 오늘부터 들이라냥, 나중에 도움 된다냥.",
        ],
        "건강운": [
            "몸보다 마음이 지친 것 같다냥, 좀 쉬라냥.",
            "일찍 자면 컨디션 좋아질 거다냥.",
            "몸 뻐근하면 스트레칭하라냥.",
            "물 좀 자주 마시라냥, 커피는 줄이라냥.",
        ],
        "인간관계운": [
            "말 한마디가 누군가에게 힘이 될 거다냥.",
            "다투는 사람들 사이에선 중립 지키라냥.",
            "오랜만에 연락 온 사람 있으면 반갑게 받으라냥.",
            "혼자 있고 싶으면 억지로 나가지 않아도 된다냥.",
        ],
    },
    "mz_saju_girl": {
        "총운": [
            "오늘 촉 미쳤어 진짜, 오후 되면 다 풀릴 예정!",
            "귀인 만날 각인데?! 주변 잘 살펴봐!",
            "직감 대로 가도 되는 날이야, 믿고 가!",
            "실수해도 노상관, 금방 괜찮아질 거야!",
        ],
        "애정운": [
            "썸이면 오늘 먼저 연락해봐, 완전 좋은 타이밍!",
            "혼자여도 오늘 우연한 만남 있을 수도 있어, 기대해!",
            "투닥거려도 금방 화해각이야, 걱정 노노!",
            "그리운 사람한테 연락 올 것 같은 느낌적 느낌!",
        ],
        "재물운": [
            "오늘 돈 좀 쓸 수도 있는데 다시 들어올 각!",
            "사고 싶은 거 하루만 참아봐, 더 좋은 딜 있을지도!",
            "돈 거래는 오늘만 좀 조심해!",
            "저축 습관 오늘부터 시작해봐, 완전 뿌듯할 듯!",
        ],
        "건강운": [
            "몸보다 마음이 좀 지쳤나봐, 오늘은 쉬어가자!",
            "일찍 자면 낼 컨디션 미쳐, 진짜!",
            "어깨 뭉쳤으면 스트레칭 좀 해줘!",
            "물 많이 마셔, 커피는 오늘만 좀 줄이고!",
        ],
        "인간관계운": [
            "단톡방에서 한마디 하면 완전 인기 많아질 듯!",
            "어색했던 사람이랑 오늘 자연스럽게 풀릴 각!",
            "오랜만에 연락 온 사람 있으면 반갑게 받아줘!",
            "혼자 있고 싶으면 억지로 약속 안 잡아도 돼!",
        ],
    },
    "saju_witch": {
        "총운": [
            "솥 속의 안개가 걷히는군요, 오후엔 흐름이 선명해질 거예요.",
            "오늘은 귀한 인연이 스칠 흐름이 보이네요, 놓치지 마세요.",
            "직감의 별이 밝게 빛나는 날이에요, 믿고 움직여도 좋아요.",
            "작은 실수는 솥 안에서 금방 녹아 사라질 거예요.",
        ],
        "애정운": [
            "촛불 두 개가 나란히 놓인 걸 보니, 오늘은 마음을 나눌 때예요.",
            "혼자인 분이라면 오늘 뜻밖의 인연이 스칠 수 있어요.",
            "가까운 사이일수록 말을 아끼는 것이 마녀의 지혜죠.",
            "그리운 이의 소식이 바람을 타고 올 수 있어요.",
        ],
        "재물운": [
            "솥 안의 금화가 오늘은 들고 나는 흐름이에요.",
            "충동보다 헤아림이 오늘의 재물을 지키는 주문이에요.",
            "금전 거래는 신중히, 마녀의 조언이에요.",
            "작은 절제가 훗날 큰 보물이 되어 돌아올 거예요.",
        ],
        "건강운": [
            "몸보다 마음이 먼저 지치는 날이에요, 잠시 쉬어가세요.",
            "일찍 잠드는 것이 오늘의 회복 주문이에요.",
            "굳은 몸을 풀어주는 것이 오늘의 처방이에요.",
            "몸이 보내는 신호를 무시하지 마세요, 무리는 금물이에요.",
        ],
        "인간관계운": [
            "무심한 말 한마디가 누군가에게 큰 힘이 될 거예요.",
            "다투는 이들 사이에서는 중심을 지키는 것이 지혜예요.",
            "오랜 인연과의 대화가 뜻밖의 좋은 흐름으로 이어질 수 있어요.",
